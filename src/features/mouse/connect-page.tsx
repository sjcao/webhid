      ...
      <header className="flex h-16 items-center justify-between px-6">
        <div className="flex items-center gap-3">
          <div className="relative h-8 w-8">
            <div className="absolute left-3 top-0 h-8 w-2 -skew-x-[26deg] bg-warn" />
            <div className="absolute left-0 top-4 h-2 w-8 -skew-x-[26deg] bg-warn" />
          </div>
      ...
      <section className="relative flex min-h-[calc(100vh-64px)] flex-col items-center justify-center px-5 pb-10">
        ...
        <div className="relative z-20 mt-10 flex w-full max-w-5xl flex-col items-center">
          <div className="relative w-full max-w-[880px]">
            <img src={mouseImage} alt="mouse" className="mx-auto max-h-[360px] w-full object-contain drop-shadow-[0_24px_38px_rgba(0,0,0,0.28)]" />
            <Button
              variant="primary"
