<template>
  <div class="slider-container relative mx-auto my-0 grid place-items-center overflow-hidden" :style="sliderStyles"
       @mouseenter="active = 1;" @mouseleave="active = 0;" @focusin="active = 1;" @focusout="active = 0;"
       @touchstart="active = 1;" @touchend="active = 0;">
    <input id="track" v-model="value" @change="handleChage" type="range" min="0" max="100"
           step="25"
...
const modelValue = defineModel<number>({required: true}) // 声明类型为 string
// 监听父组件传入的 v-model 值变化
